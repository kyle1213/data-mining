...
model_K_DR = KMeans(n_clusters=30, max_iter=100000, random_state=0)
clusters_K_DR = model_K_DR.fit(principalDf)
result_K_DR = model_K_DR.fit_predict(principalDf)
df['cluster_K_DR'] = result_K_DR
...
k_score_samples = silhouette_samples(principalComponents, df['cluster_K_DR'])
df['silhouette_coeff_K_DR'] = k_score_samples
k_average_score = silhouette_score(principalComponents, df['cluster_K_DR'])

print("average_score_K_DR: ", k_average_score, "\n")
